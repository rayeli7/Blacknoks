...
class MomoApi{
  final AccessToken accessToken = MomoApiHelpers.getAccessToken() as AccessToken;
static Future<http.StreamedResponse> postRequestToPay()async{
var headers = {
		'X-Reference-Id': '${MomoApiHelpers.getCollectionUUID()}',//changes with every transaction
		'X-Target-Environment': 'sandbox',
		'Ocp-Apim-Subscription-Key': 'b66795091e1842b5ad1c2a730bbd0db6',//does not change for a user
